"""
Django settings for hkuyg project.
"""
...
DATATYPE_LOCATIONS.append('hkuyg.datatypes')
FUNCTION_LOCATIONS.append('hkuyg.functions')
TEMPLATES[0]['DIRS'].append(os.path.join(APP_ROOT, 'functions', 'templates'))
TEMPLATES[0]['DIRS'].append(os.path.join(APP_ROOT, 'widgets', 'templates'))
TEMPLATES[0]['DIRS'].insert(0, os.path.join(APP_ROOT, 'templates'))

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'tjl4%cab7vv*&vwwx5nc!o*$b1!3e=u4kx!i4ik@&9+hl8!)1p'
...
WSGI_APPLICATION = 'hkuyg.wsgi.application'
